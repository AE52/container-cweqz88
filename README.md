...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cweqz88.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cweqz88.containers.anotherwebservice.com/
...
```
git clone git@github.com:AE52/container-cweqz88.git
cd container-cweqz88
```
...
```
docker attach container-cweqz88
```
